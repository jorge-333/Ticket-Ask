...
/* Get number of notifications for customer */
if (isset($_SESSION['customer_logged_in'])) {
    $stmt = $pdo->prepare('SELECT COUNT(*) FROM Notification WHERE customer_id = ? AND seen = ?');
    
    $stmt->execute([$_SESSION['customer_id'],False]);
	...
	<section class="home-section">
		<nav>
			<div class="sidebar-button">
				...
				<span class="dashboard">Welcome To The Customer Support Portal</span>
			</div>
